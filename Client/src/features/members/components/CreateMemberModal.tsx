...
import { CreateMemberRequest } from '@/src/features/members/types/Member';
    ...
    <SafeAreaView style={[styles.container, { backgroundColor: theme.background }]}>
      ...
      <ScrollView showsVerticalScrollIndicator={false} contentContainerStyle={styles.content}>
        <View style={styles.avatarSection}>
          <TouchableOpacity
            onPress={pickImage}
            style={[styles.avatarCircle, { backgroundColor: theme.tonalLayerLow }]}
          >
            {profileImage ? (
        ...
        <View style={styles.formSection}>
          ...
          <View>
            ...
            >
              ...
              <MaterialCommunityIcons name="calendar-edit" size={20} color={theme.subText} />
            </TouchableOpacity>
            {showDatePicker && (
              <DateTimePicker
